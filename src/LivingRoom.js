...
const LivingRoom = () => {
  ...
  // Function to dynamically import all images from the LIVINGROOM folder
  const loadLivingRoomImages = async () => {
    try {
      // This will import all images from the LIVINGROOM folder
      const imageContext = require.context('./background/LIVINGROOM', false, /\.(png|jpe?g|svg|gif|webp)$/);
      const imageFiles = imageContext.keys();
      
      const livingRoomImages = imageFiles.map((file, index) => {
      ...
      setImages(livingRoomImages);
    } catch (error) {
      console.log('No images found in LIVINGROOM folder or folder is empty');
      setImages([]);
    }
  };

  useEffect(() => {
    loadLivingRoomImages();
  }, []);
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">
              Living Room <span className="text-emerald-600">Collection</span>
            </h2>
            ...
            <p className="text-slate-600 mt-6 text-lg max-w-2xl mx-auto leading-relaxed">
              Comfortable seating and elegant coffee tables for your living room. 
              Create a welcoming space where family and friends can gather.
            </p>
          ...
          {images.length === 0 ? (
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-semibold text-slate-800 mb-4">No Living Room Images Yet</h3>
            </div>
          ) : (
                ...
                >
                  <div className="relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 border border-slate-100">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-slate-600 text-sm mb-3">Living Room Furniture Collection</p>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          handleOrder(item);
          ...
          <div className="relative max-w-5xl max-h-[90vh] w-full">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="p-6">
                ...
                <p className="text-slate-600 mb-4">Living room furniture collection</p>
                <button
